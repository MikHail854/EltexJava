...
public class MyController {
    private static final Logger logger = Logger.getLogger(String.valueOf(MyController.class));
 //   private static final Logger logger = Logger.getLogger(MyController.class);
   // private static final Logger logger = Logger.getLogger(MyController.class);
    private final Gson gson = new GsonBuilder().registerTypeAdapter(Order.class, new OrderDeserializer())
            /*.registerTypeAdapter(Orders.class, new OrdersSerializar())*/
    ...
    public String addToCard(String card_id){
        ...
        //ShoppingCart<Products> cart = new ShoppingCart<Products>();
